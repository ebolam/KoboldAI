gensettingstf = [
  ...
  "tooltip": "Shows the number of tokens when typing in text boxes. May cause lags."
	...
	"step": 1,
	"default": 1,
	"label": "Vector Database Width",
	"id": "vector_sentence_width", 
    "tooltip": "How many sentences to combine in the vector database.",
    "menu_path": "Vector Memory",
    "sub_path": "",
    "classname": "user",
    "name": "vector_sentence_width",
    "extra_classes": "var_sync_alt_system_experimental_features",
    "ui_level": 2
	},
    {
	...
	"step": 1,
	"default": 1,
	"label": "Vector Returns",
	"id": "vector_return_width", 
    "tooltip": "How many sentences to return.",
    "menu_path": "Vector Memory",
    "sub_path": "",
    "classname": "user",
    "name": "vector_return_width",
    "extra_classes": "var_sync_alt_system_experimental_features",
    "ui_level": 2
	},
    {
	...
	"default": 1,
	"label": "Max distinace",
	"id": "vector_max_distance", 
    "tooltip": "Largest distinace to allow.",
    "menu_path": "Vector Memory",
    "sub_path": "",
    "classname": "user",
	...
	"default": 1,
	"label": "Vector inputs",
	"id": "vector_input_width", 
    "tooltip": "How many sentences to feed into the search.",
    "menu_path": "Vector Memory",
    "sub_path": "",
    "classname": "user",
    "name": "vector_input_width",
    "extra_classes": "var_sync_alt_system_experimental_features",
    "ui_level": 2
	},
